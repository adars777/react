...
/* 
WE WILL TAKE THIS AS A REFRENCES FOR BUILDING THE WEBSITE
=> Header
    -LOGO
    -Nav Items
=> Body
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://tse2.mm.bing.net/th/id/OIP.qi_jXG1KvOomyGD3LAEr2AAAAA?rs=1&pid=ImgDetMain&o=7&rm=3"
        />
      </div>
...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-4e6fa11c-08ff-4873-bfe4-65074bc31e5f",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      name: "Bakingo",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2026/1/2/d11af45b-a646-4ec1-aa68-7f566a8e6bfe_50467.JPG",
      locality: "1st Block",
      areaName: "Koramangala",
